...
transactionsRouter.get("/", (req, res) => {
    ...
    if(req.query["type"] !== undefined) {
        ...
        transactionsData = transactionsData.filter((transaction) => transaction.type.toLowerCase().includes(type.toLowerCase())
    );
    }

    if(req.query["description"] !== undefined) {
        const description = req.query["description"]
        transactionsData = transactionsData.filter((transaction) => transaction.description.toLowerCase().includes(description.toLowerCase())
    );
    }
    ...
    if(req.query["category"] !== undefined) {
        ...
        transactionsData = transactionsData.filter((transaction) => transaction.category === category.id)
    }
...
transactionsRouter.get("/:id", (req, res) => {
    const transactionsData = JSON.parse(fs.readFileSync("./data/transactions.json"));
...
transactionsRouter.post("/", (req, res) => {
    ...
    fs.writeFileSync("./data/transactions.json", JSON.stringify(transactionsData))
    res.send("DONE")
})
...
transactionsRouter.delete("/:id", (req, res) => {
    ...
    const newData = transactionsData.filter((transaction) => transaction.id !== parseInt(idToDelete))
...
transactionsRouter.put("/:id", (req, res) => {
    ...
    const indexOfTransaction = transactionsData.findIndex((transaction) => transaction.id.toString() === idToChange)
...
transactionsRouter.patch("/:id", (req, res) => {
    ...
    const transactionToUpdate = transactionsData.find((transaction) => transaction.id === parseInt(idToPatch))
